<template>
    <div>
        <h2 id="page-heading">
            <span v-text="$t('workshopApp.bankAccount.home.title')" id="bank-account-heading">Bank Accounts</span>
            <router-link :to="{name: 'BankAccountCreate'}" tag="button" id="jh-create-entity" class="btn btn-primary float-right jh-create-entity create-bank-account">
                ...
                <span  v-text="$t('workshopApp.bankAccount.home.createLabel')">
        ...
        <div class="alert alert-warning" v-if="!isFetching && bankAccounts && bankAccounts.length === 0">
            <span v-text="$t('workshopApp.bankAccount.home.notFound')">No bankAccounts found</span>
        </div>
        <div class="table-responsive" v-if="bankAccounts && bankAccounts.length > 0">
            <table class="table table-striped">
                ...
                <tr>
                    ...
                    <th><span v-text="$t('workshopApp.bankAccount.user')">User</span></th>
                    <th></th>
                </tr>
                </thead>
                <tbody>
        ...
        <b-modal ref="removeEntity" id="removeEntity" >
            <span slot="modal-title"><span id="workshopApp.bankAccount.delete.question" v-text="$t('entity.delete.title')">Confirm delete operation</span></span>
            <div class="modal-body">
                <p id="jhi-delete-bankAccount-heading" v-bind:title="$t('workshopApp.bankAccount.delete.question')">Are you sure you want to delete this Bank Account?</p>
            </div>
